export const SET_SELECTED_OPTION = 'array/setSelectedOption'
export const SET_SELECTED_SUB_OPTION = 'array/setSelectedSubOption'

const initialState = {
  selectedOption: '',
  selectedSubOption: '',
  topLevelOptions: Object.freeze({
    'add items or merge arrays': 'adding',
    'find items': 'find',
    'order the items (sorting)': 'ordering',
    'remove items': 'removing',
    'return a string from array': 'string',
    'walk (iterate) over items': 'iterate',
...
export default (state = initialState, action) => {
  switch (action.type) {
    ...
    case SET_SELECTED_SUB_OPTION:
      return {
        ...state,
        selectedSubOption: action.value
      }
    default:
      return { ...state }
  }
...
export const setSelection = (type, value) => dispatch => {
  switch (type) {
    case SET_SELECTED_OPTION:
      return dispatch({ type: SET_SELECTED_OPTION, value })
    case SET_SELECTED_SUB_OPTION:
      return dispatch({ type: SET_SELECTED_SUB_OPTION, value })
    default:
      return null
  }
}
